...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="https://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
			...
			<div id="sidebar" class="column column-1-3 column-last" style="margin-top:40px">
				...
				<div class="player_adn">
					<!--<img src="<?php bloginfo('template_directory')?>/images/adn-top.png" alt="" /> -->
					<?php echo get_field('adn_player' , 'options')?>
					<!--<img src="<?php bloginfo('template_directory')?>/images/adn-bottom.png" alt="" /> -->
				</div>
...
<div class="widget">
	<div class="fb-like-box" data-href="http://www.facebook.com/prensafutbol.cl" data-height="370" data-width="298" data-colorscheme="light" data-show-faces="true" data-header="true" data-stream="false" data-show-border="false"></div>
				...
				<?php /* fin sidebar embeeeeededddd */?>
