...
if ($detect->isMobile() && !$detect->isTablet()){
	...
	get_template_part('mobile/archive-prensa-futbol-tv');
	...
	<div class="container">
		<div class="row">
			...
			<div id="content" class="column column-2-3">
				...
				$posts = get_posts(array('post_type'=>'prensa-futbol-tv','orderby'   => 'menu_order', 'order'     => 'ASC' , 'posts_per_page' => 11 , 'paged'=> $paged));
			...
			<div id="sidebar" class="column column-1-3 column-last">
				<?php get_template_part('sidebar_tv')?>
			</div>
