...
if ($detect->isMobile() && !$detect->isTablet()){
	...
	get_template_part('mobile/taxonomy-tags');
	...
	<div class="container">
		<div class="row">
			...
			<div id="content" class="column column-2-3">
				...
				//$posts = get_posts(array('post_type' => array('posts' , 'prensa-futbol-tv'), 'tags'=>$type, 'orderby'   => 'menu_order', 'order' => 'ASC' , 'posts_per_page' => 11 , 'paged'=> $paged));
				
				$posts = get_posts(array('tags'=>$type, 'orderby'   => 'menu_order', 'order' => 'ASC' , 'posts_per_page' => 11 , 'paged'=> $paged));
